  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6 min-h-screen bg-[#FEFAF6]">
      ...
      <div className="flex justify-between items-center p-4 px-6 rounded-2xl shadow-sm ">
        <h2 className="text-lg font-black text-[#102C57] uppercase">Add New Category</h2>
      </div>
      ...
      <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-[#EADBC8]">
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="flex">
              <input type="text" placeholder="No file chosen" className={`${inputClass} rounded-r-none border-r-0`} readOnly />
              <label className="bg-[#102C57] text-white px-8 py-3 rounded-r-xl text-[10px] font-black uppercase cursor-pointer hover:bg-[#1a3d75] transition-colors flex items-center tracking-widest">
                Browser
